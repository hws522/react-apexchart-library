                ...
                options={{
                    plotOptions: {
                        bar: {
                            ...
                            barHeight: barColumnWidth,
                            distributed: false,
                            rangeBarOverlap: true,
                            rangeBarGroupRows: false,
                            colors: {
                                ranges: [{
                                    from: barRangeColor[0],
                                    to: barRangeColor[1],
                                    color: barRangeColor[2]
                                }],
                                backgroundBarColors: barBackgroundStyle[0],
                                backgroundBarOpacity: barBackgroundStyle[1],
                                backgroundBarRadius: barBackgroundStyle[2],
                            },
                            dataLabels: {
                                position: barDataLabels[0],
                                maxItems: 100,
                                hideOverflowingLabels: true,
                                orientation: barDataLabels[1]
                            }
                        }
                    },
                    chart: {
...
BarChart.defaultProps = {
    ...
    barBorderRadius: 0,
    barColumnWidth: '70%',
    barRangeColor: [0, 0, undefined],
    barBackgroundStyle: [[], 1, 0],
    barDataLabels: ['top', 'horizontal']
}
