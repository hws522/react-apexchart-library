      ...
      <Chart
        ...
        options={{
          plotOptions: {
            radar: {
              size: undefined,
              offsetX: radarOffset[0],
              offsetY: radarOffset[1],
              polygons: {
                strokeColors: radarStroke[0],
                strokeWidth: radarStroke[2],
                connectorColors: radarStroke[1],
                fill: {
                  colors: radarFillColor,
                },
              },
            },
          },
          ...
          /*
           * 이 차트는 다른 XY 차트와 약간 다르기 때문에 방사형 차트의 경우 xaxis의 모든 속성이 적용되는 것은 아닙니다.
           * 방사형 차트의 x축에는 아래 나열된 키만 적용할 수 있습니다.
           */
          xaxis: {
            type: XAxisOptions[0],
...
RadarChart.defaultProps = {
  ...
  //* Radar plotOptions
  radarOffset: [0, 0],
  radarStroke: ['#e8e8e8', '#e8e8e8', 1],
  radarFillColor: undefined,
};
