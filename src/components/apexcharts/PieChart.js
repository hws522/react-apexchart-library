    ...
    <>
      <Chart
        ...
        options={{
          plotOptions: {
            pie: {
              startAngle: pieAngles[0],
              endAngle: pieAngles[1],
              expandOnClick: pieOnClick,
              offsetX: pieOffset[0],
              offsetY: pieOffset[1],
              customScale: 1,
              dataLabels: {
                offset: pieLabelOffset,
                minAngleToShowLabel: pieShowLabelAngle,
              },
              donut: {
                size: '65%',
                background: donutBackground,
                labels: {
                  show: donutLabelsShow,
                  name: {
                    show: true,
                    fontSize: '22px',
                  ...
                  value: {
                    ...
                    offsetY: 16,
                    formatter: function (val) {
                      return `${val} ${donutLabelValueSuffix}`;
                    },
                  },
                  total: {
                    show: donutTotalShow, // false
                    showAlways: false,
                    label: donutTotalStyles[0],
                    fontSize: donutTotalStyles[1],
                    fontFamily: 'Helvetica, Arial, sans-serif',
                    fontWeight: 600,
                    color: donutTotalStyles[2],
...
PieChart.defaultProps = {
  ...
  pieOffset: [0, 0],
  pieLabelOffset: 0,
  pieShowLabelAngle: 10,
  donutBackground: 'transparent',
  donutLabelsShow: false,
  donutLabelValueSuffix: '',
  donutTotalShow: false,
  donutTotalStyles: ['Total', '22px', '#373d3f'],
};
