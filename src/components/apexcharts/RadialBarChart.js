...
const RadialBarChart = ({
  ...
  radialBarTrackStyle,
  radialBarDataLabels,
  radialBarDataLabelsName,
  radialBarDataLabelsValue,
  radialBarTotal,
}) => {
  return (
    <>
      <Chart
        className={'chart-radial-bar'}
        type={'radialBar'}
        height={chartHeight}
        width={chartWidth}
        series={chartSeries}
        options={{
          plotOptions: {
            radialBar: {
              inverseOrder: radialBarInverse,
              startAngle: radialBarAngle[0],
              endAngle: radialBarAngle[1],
              offsetX: radialBarOffset[0],
              offsetY: radialBarOffset[1],
              hollow: {
                margin: radialBarHollow[0],
                size: radialBarHollow[1],
                background: radialBarHollow[2],
                // image: undefined,
                // imageWidth: 150,
                // imageHeight: 150,
                // imageOffsetX: 0,
              ...
              track: {
                show: radialBarTrack[0],
                startAngle: radialBarTrack[1],
                endAngle: radialBarTrack[2],
                background: radialBarTrackStyle[0],
                strokeWidth: radialBarTrackStyle[1],
                opacity: radialBarTrackStyle[2],
                margin: radialBarTrackStyle[3],
                dropShadow: {
                  enabled: false,
                  top: 0,
                  left: 0,
              ...
              dataLabels: {
                show: radialBarDataLabels,
                name: {
                  show: radialBarDataLabelsName[0],
                  fontSize: radialBarDataLabelsName[1],
                  fontFamily: undefined,
                  fontWeight: radialBarDataLabelsName[2],
                  color: radialBarDataLabelsName[3],
                  offsetY: radialBarDataLabelsName[4],
                },
                value: {
                  show: radialBarDataLabelsValue[0],
                  fontSize: radialBarDataLabelsValue[1],
                  fontFamily: undefined,
                  fontWeight: radialBarDataLabelsValue[2],
                  color: radialBarDataLabelsValue[3],
                  offsetY: radialBarDataLabelsValue[4],
                  formatter: function (val) {
                    return val + '%';
                  },
                },
                total: {
                  show: radialBarTotal[0],
                  label: radialBarTotal[1],
                  color: radialBarTotal[2],
                  fontSize: radialBarTotal[3],
                  fontFamily: undefined,
                  fontWeight: radialBarTotal[4],
...
RadialBarChart.defaultProps = {
  ...
  /****************************************************************/
  //* PolarArea plotOptions
  radialBarLabels: [],
  radialBarInverse: false,
  radialBarAngle: [0, 360],
  radialBarOffset: [0, 0],
  radialBarHollow: [5, '50%', 'transparent'],
  radialBarTrack: [true, undefined, undefined],
  radialBarTrackStyle: ['#f2f2f2', '97%', 1, 5],
  radialBarDataLabels: true,
  radialBarDataLabelsName: [true, '16px', 600, undefined, -10],
  radialBarDataLabelsValue: [true, '14px', 400, undefined, 16],
  radialBarTotal: [true, 'Total', '#373d3f', '16px', 600],
};
