      ...
      <Chart
        ...
        options={{
          plotOptions: {
            polarArea: {
              rings: {
                strokeWidth: polarRingStroke[0],
                strokeColor: polarRingStroke[1],
              },
              spokes: {
                strokeWidth: polarSpokeStroke[0],
                connectorColors: polarSpokeStroke[1],
              },
            },
          },
          chart: {
...
PolarAreaChart.defaultProps = {
  ...
  polarLabels: [],
  polarRingStroke: [1, '#e8e8e8'],
  polarSpokeStroke: [1, '#e8e8e8'],
};
